...
def seed_default_voice_templates(db: Session, project_id: str | None = None) -> None:
    """历史兼容入口：早期版本在这里种入 6 个 OpenAI 演示音色（disabled）。

    真实可用的系统模板统一由 seed_volcengine_voice_templates 维护，
    这里保留函数签名以兼容既有调用点，不再种入不可用的演示音色。
    """
...
VOLCENGINE_VOICE_TEMPLATES = [
    ...
    {
        "name": "豆包·Vivi 2.0（女声·通用）",
        "voice_name": "zh_female_vv_uranus_bigtts",
        "provider_voice_id": "zh_female_vv_uranus_bigtts",
        "gender": "female",
        "gender_style": "female",
        "speaking_style": "亲和自然",
        "voice_provider": "volcengine",
    ...
    {
        "name": "豆包·魅力女友 2.0（女声·亲和）",
        "voice_name": "zh_female_meilinvyou_uranus_bigtts",
        "provider_voice_id": "zh_female_meilinvyou_uranus_bigtts",
        "gender": "female",
        "gender_style": "female",
        "speaking_style": "亲和自然",
        "voice_provider": "volcengine",
    ...
    {
        "name": "豆包·佩奇猪 2.0（女声·视频配音）",
        "voice_name": "zh_female_peiqi_uranus_bigtts",
        "provider_voice_id": "zh_female_peiqi_uranus_bigtts",
        "gender": "female",
        "gender_style": "female",
        "speaking_style": "清晰客观",
        "voice_provider": "volcengine",
    ...
    {
        "name": "豆包·Tina老师 2.0（女声·中英教学）",
        "voice_name": "zh_female_yingyujiaoxue_uranus_bigtts",
        "provider_voice_id": "zh_female_yingyujiaoxue_uranus_bigtts",
        "gender": "female",
        "gender_style": "female",
        "speaking_style": "清晰客观",
        "voice_provider": "volcengine",
    ...
    {
        "name": "豆包·刘飞 2.0（男声·通用）",
        "voice_name": "zh_male_liufei_uranus_bigtts",
        "provider_voice_id": "zh_male_liufei_uranus_bigtts",
        "gender": "male",
        "gender_style": "male",
        "speaking_style": "正式稳重",
        "voice_provider": "volcengine",
    ...
    {
        "name": "豆包·阳光青年 2.0（男声·明快）",
        "voice_name": "zh_male_yangguangqingnian_uranus_bigtts",
        "provider_voice_id": "zh_male_yangguangqingnian_uranus_bigtts",
        "gender": "male",
        "gender_style": "male",
        "speaking_style": "激昂有力",
        "voice_provider": "volcengine",
    ...
    {
        "name": "豆包·儒雅逸辰 2.0（男声·视频配音）",
        "voice_name": "zh_male_ruyayichen_uranus_bigtts",
        "provider_voice_id": "zh_male_ruyayichen_uranus_bigtts",
        "gender": "male",
        "gender_style": "male",
        "speaking_style": "沉稳大气",
        "voice_provider": "volcengine",
    ...
    {
        "name": "豆包·深夜播客 2.0（男声·低沉叙事）",
        "voice_name": "zh_male_shenyeboke_uranus_bigtts",
        "provider_voice_id": "zh_male_shenyeboke_uranus_bigtts",
        "gender": "male",
        "gender_style": "male",
        "speaking_style": "沉稳大气",
        "voice_provider": "volcengine",
    ...
    {
        "name": "豆包·傲娇霸总 2.0（男声·磁性）",
        "voice_name": "zh_male_aojiaobazong_uranus_bigtts",
        "provider_voice_id": "zh_male_aojiaobazong_uranus_bigtts",
        "gender": "male",
        "gender_style": "male",
        "speaking_style": "正式稳重",
        "voice_provider": "volcengine",
    ...
    {
        "name": "豆包·擎苍 2.0（男声·角色扮演）",
        "voice_name": "zh_male_qingcang_uranus_bigtts",
        "provider_voice_id": "zh_male_qingcang_uranus_bigtts",
        "gender": "male",
        "gender_style": "male",
        "speaking_style": "激昂有力",
        "voice_provider": "volcengine",
    ...
    {
        "name": "豆包·猴哥 2.0（男声·视频配音）",
        "voice_name": "zh_male_sunwukong_uranus_bigtts",
        "provider_voice_id": "zh_male_sunwukong_uranus_bigtts",
        "gender": "male",
        "gender_style": "male",
        "speaking_style": "激昂有力",
        "voice_provider": "volcengine",
    ...
    {
        "name": "豆包·熊二 2.0（男声·角色扮演）",
        "voice_name": "zh_male_xionger_uranus_bigtts",
        "provider_voice_id": "zh_male_xionger_uranus_bigtts",
        "gender": "male",
        "gender_style": "male",
        "speaking_style": "亲和自然",
        "voice_provider": "volcengine",
    ...
    {
        "name": "豆包·四郎 2.0（男声·角色扮演）",
        "voice_name": "zh_male_silang_uranus_bigtts",
        "provider_voice_id": "zh_male_silang_uranus_bigtts",
        "gender": "male",
        "gender_style": "male",
        "speaking_style": "沉稳大气",
        "voice_provider": "volcengine",
